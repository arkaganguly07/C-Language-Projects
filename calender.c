...
void SetColor (int ForgC)
{
    ...
    if (GetConsoleScreenBufferInfo(hStdOut, &csbi))
    {
        ...
        and add in the forground color
        */
    ...
    while (1)
    {
        ...
        switch (choice)
        {
            case 1:
                ...
                printf("Day is : %s",getDay(date.dd, date.mm, date.yyyy));
            ...
            case 2:
                ...
                scanf("%d %d", &date.mm, &date.yyyy);
                system("cls");
                while (ch != 'q')
                {
                    printMonth(date.mm, date.yyyy, 20,5);
                    ch = getch();
                    if (ch == 'n')
                    {
                        increase_month(&date.mm, &date.yyyy);
                        system("cls");
                        printMonth(date.mm, date.yyyy, 20, 5);
                    }
                    else if (ch == 'p')
                    {
                        decrease_month(&date.mm, &date.yyyy);
                        system("cls");
                        printMonth(date.mm, date.yyyy, 20, 5);
                    }
                    else if (ch == 's')
